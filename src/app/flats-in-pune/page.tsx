...
const SECTIONS = [
    {
        ...
        links: [
            ...
            { href: '/properties/2-bhk-flats-hadapsar-pune', label: '2 BHK Flats in Hadapsar' },
            { href: '/properties/3-bhk-flats-hadapsar-pune', label: '3 BHK Flats in Hadapsar' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/properties/luxury-apartments-bavdhan-pune', label: 'Luxury Apartments Bavdhan' },
            { href: '/properties/luxury-apartments-with-golf-view-bavdhan', label: 'Golf View Apartments Bavdhan' },
