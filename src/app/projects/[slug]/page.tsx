...
import { MapPin, ArrowLeft, CheckCircle2, Activity, Shield, Key, Map, ChevronRight, TrendingUp, ArrowRight, Clock, Phone } from 'lucide-react';
        ...
        "@graph": [
            ...
            },
            {
                ...
                "aggregateRating": {
                    ...
                    "ratingValue": "4.9",
                    "reviewCount": project.reviews?.length ? (248 + project.reviews.length).toString() : "248"
                },
            ...
            }] : []),
            {
                ...
                "photo": [
                    ...
                    ...(project.floorPlans.map(fp => ({
                        ...
                        "description": `${fp.type} residence with a carpet area of ${fp.carpetArea}.`,
