...
const footerLinks = {
    projects: [
        ...
        { href: '/projects/joyville-celestia-hinjewadi', label: 'Joyville Celestia' },
        { href: '/projects/joyville-skyluxe-hinjewadi', label: 'Skyluxe Edition' },
        { href: '/projects/vanaha-golfland-bavdhan', label: 'Vanaha Golfland' },
        { href: '/projects/vanaha-springs-bavdhan', label: 'Vanaha Springs' },
        { href: '/projects/shapoorji-treetopia-purandar', label: 'Shapoorji Treetopia' },
    ],
    localities: [
    ...
    properties: [
        ...
        { href: '/properties/luxury-apartments-hinjewadi-phase-1', label: 'Luxury Apartments Hinjewadi' },
        { href: '/properties/new-launch-projects-hinjewadi-2025', label: 'New Launch Hinjewadi 2025' },
