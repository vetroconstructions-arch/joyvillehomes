            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {floorPlans.map((plan, idx) => (
                    <div
                        ...
                        className="bg-[#EEF2F6] border border-[#1D4F9C]/60 p-6 text-center hover:bg-[#EEF2F6] transition-colors group cursor-pointer"
                    >
                        ...
                        <button className="text-[10px] uppercase tracking-widest text-[#1A1A1A] group-hover:text-[#1D4F9C] transition-colors flex items-center gap-1 mx-auto">
